...
class MPLoop:
    ...
    def extract(self, win):
        ...
        self.shots_p1.append(self.p2.game.shots)
        self.shots_p2.append(self.p1.game.shots)
        self.game_length.append(self.cnt + 1)
        self.config_p1.append(self.p1.game.ships)
        self.config_p2.append(self.p2.game.ships)
        if self.p1.game.game_forfeit:
            self.ff_p1 += 1
        elif self.p2.game.game_forfeit:
            self.ff_p2 += 1
